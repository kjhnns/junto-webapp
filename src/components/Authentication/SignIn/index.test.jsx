...
import { render, userEvent, fireEvent, wait } from '@test'
...
jest.mock('gatsby-plugin-firebase', () => {
  return {
    auth: jest.fn(() => ({
      // signInWithEmailAndPassword: jest.fn(() => console.log('WHAT UP')),
    })),
  }
})
...
describe('<SignIn>', () => {
  ...
  test('Renders', async () => {
    ...
    // firebase.auth.mockResolvedValueOnce({ data: { success: true } })
  })
